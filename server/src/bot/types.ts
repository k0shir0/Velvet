...
/** A slash command contributed by a module. */
export interface SlashCommand {
  /** Command name, used to route incoming interactions. */
  name: string;
  /** A builder (or anything serializable to the command JSON). */
...
export interface VelvetModule {
  ...
  /** Slash commands contributed while the module is enabled. */
